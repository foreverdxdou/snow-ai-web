...
export default function RolePage() {
    ...
    const handleSubmit = useCallback(async () => {
        try {
            ...
            setSnackbar({
                open: true,
                message: t(`common.role.${editingRole ? 'updateError' : 'createError'}`),
                severity: 'error',
            });
        }
                ...
                >
                    <SearchBar>
                        <CommonInput
                            ...
                            onChange={(value) => setFormData({ ...formData, roleName: value as string })}
                        />
                        <CommonInput
                            label={t('common.role.code')}
                            value={formData.roleCode}
                            onChange={(value) => setFormData({ ...formData, roleCode: value as string })}
                        />
                        <CommonButton
                            buttonVariant="reset"
                            onClick={() => {
