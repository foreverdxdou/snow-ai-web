...
export default function QaPage() {
    ...
    return (
        <Box sx={{ 
            height: '100vh', 
            display: 'flex',
            bgcolor: 'background.default', // 统一背景色
        }}>
            {/* 左侧列 - Snow AI */}
            <Box sx={{
                width: 240,
                ...
                <Box sx={{
                    ...
                    >
                        ...
                        <Box sx={{ 
                            ...
                            {/* 知识库选择器 */}
                            <Tooltip title={selectedKbs.length === 0 ? t('qa.selectKnowledgeBase') : t('qa.selectedKnowledgeBase')}>
                                <FormControl size="small" sx={{ 
                                    ...
                                    <Select
                                        multiple
                                        value={selectedKbs}
                                        onChange={(e) => setSelectedKbs(typeof e.target.value === 'string' ? [] : e.target.value)}
                                        displayEmpty
                                        IconComponent={() => null}
                                        ...
                                        sx={{
                                            ...
                                            '& .MuiSelect-select': {
                                                display: 'flex',
                                                alignItems: 'center',
                                                padding: selectedKbs.length === 0 ? '8px' : '8px 8px',
            ...
            <Box sx={{
                ...
                {/* 历史会话列表 */}
                <Collapse in={showChatHistory} sx={{ flex: 1, overflow: 'hidden' }}>
                    <List sx={{
                        height: '100%',
                        overflow: 'auto',
                        '&::-webkit-scrollbar': {
